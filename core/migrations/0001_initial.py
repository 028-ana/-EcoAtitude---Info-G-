    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('material_type', models.CharField(choices=[('papel', 'Papel/Papelão'), ('plastico', 'Plástico'), ('vidro', 'Vidro'), ('metal', 'Metal'), ('eletronico', 'Eletrônicos'), ('organico', 'Orgânico')], default='papel', max_length=20)),
